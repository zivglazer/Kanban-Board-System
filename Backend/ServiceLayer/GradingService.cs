...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return sf.UserService.Login(email, password);
        }
        ...
        {
            return sf.BoardService.LimitColumn(email, boardName, columnIndex, limit);
        }
        ...
        {
            return sf.BoardService.GetColumnLimit(email, boardName, columnIndex);
        ...
        {
            return sf.BoardService.GetColumnName(email, boardName, columnIndex);
        ...
        {
            return sf.TaskService.AddTask(email, boardName, title, description, dueDate);
        }
        ...
        {
            return sf.TaskService.UpdateTaskDueDate(email, boardName, columnIndex, taskId, dueDate);
        }
        ...
        {
            return sf.TaskService.UpdateTaskTitle(email, boardName, columnIndex, taskId, title);
        }
        ...
        {
            return sf.TaskService.UpdateTaskDescription(email, boardName, columnIndex, taskId, description);
        }
        ...
        {
            return sf.TaskService.AdvanceTask(email, boardName, columnIndex, taskId);
        }
        ...
        {
            return sf.BoardService.GetColumn(email, boardName, columnIndex);
        }
        ...
        {
            return sf.TaskService.InProgressTasks(email);

            /*Response<List<TaskSL>> response = JsonSerializer.Deserialize<Response<List<TaskSL>>>(jsonResponse);
            
            if (response.ReturnValue != null)
                return responseMaker(jsonResponse, response.ReturnValue);

            return responseMaker(jsonResponse, null);*/
        }
        ...
        {
            Response<List<BoardSL>> boards = JsonSerializer.Deserialize<Response<List<BoardSL>>>(sf.BoardService.GetUserBoards(email));

            if (Controller._state == 1)
                return boards.ToJson();

            List<int> ans = new List<int>();

            if(boards.ErrorOccured)
                return new Response<List<int>>(boards.ErrorMessage).ToJson();

            foreach (var board in boards.ReturnValue)
            {
                ans.Add(board.BoardID);
            }
            return new Response<List<int>>(ans,null).ToJson();
        }
        ...
        {
            return sf.BoardService.TransferOwnership(boardName,currentOwnerEmail, newOwnerEmail);
        }
